...
namespace Quan_ly_may_bay {
    ...
    public partial class QLCBDataSet1 : global::System.Data.DataSet {
        ...
        private global::System.Data.DataRelation relationFK_NhanVien2;
        ...
        internal void InitVars(bool initTable) {
            ...
            this.relationFK_NhanVien2 = this.Relations["FK_NhanVien2"];
        }
        ...
        private void InitClass() {
            ...
            this.relationFK_NhanVien2 = new global::System.Data.DataRelation("FK_NhanVien2", new global::System.Data.DataColumn[] {
                        this.tableChucVu.MaCVColumn}, new global::System.Data.DataColumn[] {
                        this.tableNhanVien.MaCVColumn}, false);
            this.Relations.Add(this.relationFK_NhanVien2);
        }
        ...
        public partial class ChucVuDataTable : global::System.Data.TypedTableBase<ChucVuRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ChucVuRow AddChucVuRow(string MaCV, string TenCV, string MoTa) {
        ...
        public partial class NhanVienDataTable : global::System.Data.TypedTableBase<NhanVienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public NhanVienRow AddNhanVienRow(string HoTenNV, System.DateTime NgaySinh, string DiaChi, string GioiTinh, System.DateTime NgayVaoLam, ChucVuRow parentChucVuRowByFK_NhanVien2, string SDT, int ID, int Luong) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        ID,
                        Luong};
                if ((parentChucVuRowByFK_NhanVien2 != null)) {
                    columnValuesArray[6] = parentChucVuRowByFK_NhanVien2[0];
                }
        ...
        public partial class ChucVuRow : global::System.Data.DataRow {
            ...
            public NhanVienRow[] GetNhanVienRows() {
                if ((this.Table.ChildRelations["FK_NhanVien2"] == null)) {
                    return new NhanVienRow[0];
                }
                else {
                    return ((NhanVienRow[])(base.GetChildRows(this.Table.ChildRelations["FK_NhanVien2"])));
                }
            }
        }
        ...
        public partial class NhanVienRow : global::System.Data.DataRow {
            ...
            public ChucVuRow ChucVuRow {
                get {
                    return ((ChucVuRow)(this.GetParentRow(this.Table.ParentRelations["FK_NhanVien2"])));
                }
                set {
                    this.SetParentRow(value, this.Table.ParentRelations["FK_NhanVien2"]);
                }
            }
...
namespace Quan_ly_may_bay.QLCBDataSet1TableAdapters {
    ...
    public partial class ChucVuTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[ChucVu] WHERE (([MaCV] = @Original_MaCV) AND ((@IsNull_TenCV =" +
                " 1 AND [TenCV] IS NULL) OR ([TenCV] = @Original_TenCV)) AND ((@IsNull_MoTa = 1 A" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[ChucVu] ([MaCV], [TenCV], [MoTa]) VALUES (@MaCV, @TenCV, @MoTa" +
                ");\r\nSELECT MaCV, TenCV, MoTa FROM ChucVu WHERE (MaCV = @MaCV)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[ChucVu] SET [MaCV] = @MaCV, [TenCV] = @TenCV, [MoTa] = @MoTa WHERE (([MaCV] = @Original_MaCV) AND ((@IsNull_TenCV = 1 AND [TenCV] IS NULL) OR ([TenCV] = @Original_TenCV)) AND ((@IsNull_MoTa = 1 AND [MoTa] IS NULL) OR ([MoTa] = @Original_MoTa)));
SELECT MaCV, TenCV, MoTa FROM ChucVu WHERE (MaCV = @MaCV)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Quan_ly_may_bay.Properties.Settings.Default.QLCBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaCV, TenCV, MoTa FROM dbo.ChucVu";
        ...
        public virtual int Fill(QLCBDataSet1.ChucVuDataTable dataTable) {
        ...
        public virtual QLCBDataSet1.ChucVuDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QLCBDataSet1.ChucVuDataTable dataTable = new QLCBDataSet1.ChucVuDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QLCBDataSet1.ChucVuDataTable dataTable) {
    ...
    public partial class NhanVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[NhanVien] ([HoTenNV], [NgaySinh], [DiaChi], [GioiTinh], [NgayVaoLam], [MaCV], [SDT], [ID], [Luong]) VALUES (@HoTenNV, @NgaySinh, @DiaChi, @GioiTinh, @NgayVaoLam, @MaCV, @SDT, @ID, @Luong);
SELECT MaNV, HoTenNV, NgaySinh, DiaChi, GioiTinh, NgayVaoLam, MaCV, SDT, ID, Luong FROM NhanVien WHERE (MaNV = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NhanVien] SET [HoTenNV] = @HoTenNV, [NgaySinh] = @NgaySinh, [DiaChi] = @DiaChi, [GioiTinh] = @GioiTinh, [NgayVaoLam] = @NgayVaoLam, [MaCV] = @MaCV, [SDT] = @SDT, [ID] = @ID, [Luong] = @Luong WHERE (([MaNV] = @Original_MaNV) AND ((@IsNull_HoTenNV = 1 AND [HoTenNV] IS NULL) OR ([HoTenNV] = @Original_HoTenNV)) AND ((@IsNull_NgaySinh = 1 AND [NgaySinh] IS NULL) OR ([NgaySinh] = @Original_NgaySinh)) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ((@IsNull_GioiTinh = 1 AND [GioiTinh] IS NULL) OR ([GioiTinh] = @Original_GioiTinh)) AND ((@IsNull_NgayVaoLam = 1 AND [NgayVaoLam] IS NULL) OR ([NgayVaoLam] = @Original_NgayVaoLam)) AND ((@IsNull_MaCV = 1 AND [MaCV] IS NULL) OR ([MaCV] = @Original_MaCV)) AND ((@IsNull_SDT = 1 AND [SDT] IS NULL) OR ([SDT] = @Original_SDT)) AND ((@IsNull_ID = 1 AND [ID] IS NULL) OR ([ID] = @Original_ID)) AND ((@IsNull_Luong = 1 AND [Luong] IS NULL) OR ([Luong] = @Original_Luong)));
SELECT MaNV, HoTenNV, NgaySinh, DiaChi, GioiTinh, NgayVaoLam, MaCV, SDT, ID, Luong FROM NhanVien WHERE (MaNV = @MaNV)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT MaNV, HoTenNV, NgaySinh, DiaChi, GioiTinh, NgayVaoLam, MaCV, SDT, ID, Luon" +
                "g FROM dbo.NhanVien";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(int Original_MaNV, string Original_HoTenNV, global::System.Nullable<global::System.DateTime> Original_NgaySinh, string Original_DiaChi, string Original_GioiTinh, global::System.Nullable<global::System.DateTime> Original_NgayVaoLam, string Original_MaCV, string Original_SDT, global::System.Nullable<int> Original_ID, global::System.Nullable<int> Original_Luong) {
            ...
            if ((Original_ID.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[16].Value = ((int)(Original_ID.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string HoTenNV, global::System.Nullable<global::System.DateTime> NgaySinh, string DiaChi, string GioiTinh, global::System.Nullable<global::System.DateTime> NgayVaoLam, string MaCV, string SDT, global::System.Nullable<int> ID, global::System.Nullable<int> Luong) {
            if ((HoTenNV == null)) {
        ...
        public virtual int Update(
            ...
            if ((Original_Luong.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[27].Value = ((int)(Original_Luong.Value));
            }
            else {
        ...
        public virtual int Update(
                    ...
                    global::System.Nullable<int> Original_ID, 
                    global::System.Nullable<int> Original_Luong) {
            return this.Update(HoTenNV, NgaySinh, DiaChi, GioiTinh, NgayVaoLam, MaCV, SDT, ID, Luong, Original_MaNV, Original_HoTenNV, Original_NgaySinh, Original_DiaChi, Original_GioiTinh, Original_NgayVaoLam, Original_MaCV, Original_SDT, Original_ID, Original_Luong, Original_MaNV);
        }
    }
